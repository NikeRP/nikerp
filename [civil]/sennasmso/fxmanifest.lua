...
files {
	...
	'common/sennasmsocontentunlocks.meta',
	'common/shop_vehicle.meta',
...
data_file 'VEHICLE_SHOP_FILE' 'common/shop_vehicle.meta'
data_file 'CONTENT_UNLOCKING_META_FILE' 'common/sennasmsocontentunlocks.meta'
