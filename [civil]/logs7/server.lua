...
local webhook1 = "https://discord.com/api/webhooks/1194370389267193926/qLrHkrgSRo8ov8rF9cdXExYlwUfa3UnbyEukk_CN1ur_TlhDclJAqjWLSNwo3DPWnzpP" -- Create a webhook and put it here
local webhook2 = "https://discord.com/api/webhooks/1194370389267193926/qLrHkrgSRo8ov8rF9cdXExYlwUfa3UnbyEukk_CN1ur_TlhDclJAqjWLSNwo3DPWnzpP" -- Create a webhook and put it here
local username = "Srook's Logs" -- Put your server name or anything else you want the author of the message to be
